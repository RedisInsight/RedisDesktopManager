...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "ubu12debug" , primary: true do |ubu12debug|
    ...
    ubu12debug.vm.provision :shell, :path => "./vagrant-provision/install_ubuntu-debug.sh"
  end 
  ...
  config.vm.define "ubu12" do |ubu12|
    ...
    ubu12.vm.provision :shell, :path => "./vagrant-provision/install_ubuntu.sh"
  end 
  ...
  config.vm.define "debi6" do |debi6|
    ...
    debi6.vm.provision :shell, :path => "./vagrant-provision/install_ubuntu.sh"
  end 
  ...
  config.vm.define "debi7" do |debi7|32
    ...
    debi7.vm.provision :shell, :path => "./vagrant-provision/install_debi7.sh"
  end 
  ...
  config.vm.define "debi7_32" do |debi7_32|
    ...
    debi7_32.vm.provision :shell, :path => "./vagrant-provision/install_debi7.sh"
  end 
