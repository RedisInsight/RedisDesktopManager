    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                ColumnLayout {
                    RichTextWithLinks { html: '<span style="font-size:24pt;">Redis Desktop Manager</span>'}
                    RichTextWithLinks { html: '<span style="padding-left:53px; font-size: 11px; line-height: 21px"><b>Version</b> ' + appVersion +' &nbsp;&nbsp;&nbsp; '
                    ...
                    RichTextWithLinks { html: '<span style="font-size: 11px;">Many thanks to <a href="http://redisdesktop.com/#contributors">our amazing Contributors</a> and '
                                              + '<a href="http://redisdesktop.com/community">Community</a></span>'}
                }
            }

            RichTextWithLinks { html: '<span style="font-size: 8px;">Used third party software and images:<a href="http://qt-project.org/"> Qt5</a>; '
            ...
            RichTextWithLinks {
                html: '<span style="font-size: 13px;"><a style=" color: red;" href="https://github.com/uglide/RedisDesktopManager/issues"><img  src="qrc:/images/alert.png" />&nbsp;Report issue</a> '
                      ...
                      + '<a style="font-size: 13px; " href="https://github.com/uglide/RedisDesktopManager/stargazers"><img  src="qrc:/images/github.png" />&nbsp;Star!</a></span>'
            }
        }
    }
}
